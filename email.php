    ...
    <div class="wrapper">
        ...
        <main>
            ...
            <section class="form_section">
                <div class="form__vse">
                    <form action="metod/ema.php" method="post">
                    <h1 class="hh">Ваши отзывы и предложения</h1>
                        <input type="text" placeholder="name" name="name">
                        <input type="text" placeholder="famili" name="famili">     
                        <input type="email" placeholder="email" name="email">
                        <input type="text" placeholder="namber" name="namber">
                        <input type="text" placeholder="comment" name="comment">
                        <div class="baton_biv">
                            <button type="submit" class="baton bg_fff">Отправить</button>
                        </div>
