    ...
    <div class="wrapper">
                    ...
                    <nav class="navbar">
                        <div class="container">
                            <div class="navbar__wrap">
                                <a href="index.html" class="logo" id="logo"><img src="assets/img/alt logo.png" alt="logo"
                                        class="logo"></a>
        ...
        <footer class="footer">
            <section class="section_footer">
                <p class="slo">Скорее всего, вы попали сюда из-за ошибки страницы.</p>
                <p class="slo">Попробуйте вернуться на <a href="index.php" class="opp">главную страницу </a>или связаться с <a href="https://t.me/No_longer_a_loner"  class="opp">администрацией сайта.</a></p>
